...
<body>
	...
	<cc:set property="pw" target="${mm }" value="1q2w3e"/>
	${mm }<br>
	<!-- getter 를 땡긴다 -->
	<%-- ${mm.pid }  ==>  mm.getPid() --%>
	...
	<cc:choose>
		<cc:when test="${jum >=80 }">
			<cc:set var="res2" value="우수"></cc:set>
		</cc:when>
		<cc:when test="${jum >=60 }">
			<cc:set var="res2" value="양호"></cc:set>
		</cc:when>
		<cc:otherwise>
			<cc:set var="res2" value="미흡"></cc:set>
		</cc:otherwise>
	</cc:choose>
